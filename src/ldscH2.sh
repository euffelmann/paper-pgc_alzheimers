...
helpString="
usage: sbatch ldscH2.sh -f <gwas-sumstat-file> -e <pheno-name> [-o <output-directory>] [-m <munge-extra-options>] [-h <h2-extra-options>] [-l <ld-score-file>]\n
...
while getopts f:o:e:h:l: option
do
 case "${option}"
 in
